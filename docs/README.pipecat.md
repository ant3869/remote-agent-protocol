# Pipecat (vendored framework)

This is the upstream README for the **Pipecat** framework vendored under
`src/pipecat`. It documents the framework, not this application -- its setup
steps, clone URLs, and contribution instructions all refer to
https://github.com/pipecat-ai/pipecat. For Remote Agent Protocol itself, see
the [repository README](../README.md). The framework changelog is
[CHANGELOG.pipecat.md](CHANGELOG.pipecat.md).
